...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-screen min-h-[100svh] [min-height:100dvh] flex items-end">
      ...
      <div className="relative z-10 px-6 md:pl-[10vw] lg:pl-[10vw] w-full pb-[41vh]">
        <div className="inline-block bg-[#6fc238] text-white px-4 md:px-6 py-0.5 text-base md:text-2xl lg:text-2.9xl font-extrabold uppercase tracking-wide mb-3 shadow-lg">
          We invest in, build, and own companies that convert
        </div>

        <h1 className="text-white text-4xl sm:text-5xl md:text-7xl lg:text-[80px] font-black tracking-tighter drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] leading-tight flex items-center flex-nowrap whitespace-nowrap">
